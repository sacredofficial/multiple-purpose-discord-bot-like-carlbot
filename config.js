module.exports = {
    "registercommands" : false,
     "token": "OTU3NDQ1MTgyNzM4MDA2MDE3.Yj-4UA.qUk7CrCNG6HtTggYzAX3IFNWQpc",
...
defaultleavemessage: "{user} Left, Invited by {inviter}",
  basiclang: "en", //The basic language of the bot, "fr" for French and "en" for English
    ...
    start: {
        loading: "Verdant Security!", //Loading status
        activity: "Team Verdant!" //Status
    },
